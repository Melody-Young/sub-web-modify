...
export default {
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "MY负载均衡后端【vless reality+hy1+hy2】": "https://subapi.me1one.qzz.io",
          "CM应急备用后端【vless reality+hy1+hy2】": "https://subapi.fxxk.dedyn.io",
          "肥羊增强型后端【vless reality+hy1+hy2】": "https://url.v1.mk",
          "肥羊备用后端【vless reality+hy1+hy2】": "https://api.v1.mk",
        },
        backendOptions: [
          { value: "https://subapi.me1one.qzz.io" },
        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "MY_Online MiniAI版 不识别地区(与Github同步)",
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://subapi.me1one.qzz.io" : this.getUrlParam(),
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`
apiurl.v1.mk已被蔷，请更换最新的url.v1.mk
本站官方TG交流群：https://t.me/feiyangdigital" target="_blank" style="color:red;font-size:20px;text-decoration:none">点击加入
IEPL高端机场（原生支持奈飞非自制剧、Disney Plus、HBO等各种流媒体，支持Chat-GPT和ISP住宅IP助力Tiktok等跨境贸易使用）：ttps://www.mcwy.org" style="color:red;font-size:20px;text-decoration:none">点击注册
奈飞、ChatGPT合租（优惠码：feiyang）：https://hezu.v1.mk/" style="color:red;font-size:20px;text-decoration:none">点击上车
115蓝光4K原盘内部资源群：https://115.metshop.top" target="_blank" style="color:red;font-size:20px;text-decoration:none">点击查看
本站服务器赞助机场-牧场物语，是一家拥有BGP中继+IEPL企业级内网专线的高端机场，适合各个价位要求的用户，牧场物语采用最新的奈飞非自制剧解决方案，出口随机更换IP，确保尽可能的每个用户可以用上独立IP，以此来稳定解决奈飞非自制剧的封锁，并推出7*24小时奈飞非自制剧节点自动检测系统，用户再也不用自己手动一个个的乱试节点了，目前牧场的新加坡，台湾等节区域点均可做到24H稳定非自制剧观看，支持Chat-GPT和ISP住宅IP助力Tiktok等跨境贸易使用！
`, '信息面板', {
