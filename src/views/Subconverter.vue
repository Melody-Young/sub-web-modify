  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "CM负载均衡后端【vless reality+hy1+hy2】": "https://subapi.me1one.qzz.io",
